      ...
      <Layout {...this.props} className="home">
        <Carousel autoPlay infiniteLoop showThumbs={false} showIndicators={false} showStatus={false}>
            <div className="display-item">
              <img src={require('$assets/images/banner-image-1.jpg')}/>
              <div className="title-container">
                <div className="title-area">
                  <div className="title-text">{ReactHtmlParser(promotionItemTitle)}</div>
                  <div className="subtitle-text">{ReactHtmlParser(promotionItemSubtitle)}</div>
                </div>
              </div>
            </div>
            <div>
              <img src={require('$assets/images/banner-image-2.jpg')} />
            </div>
          </Carousel>
